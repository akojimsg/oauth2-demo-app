package com.oauth2demo.server.service;

import java.util.HashSet;
import java.util.Set;

import com.oauth2demo.server.model.entity.AuthorizationConsent;
import com.oauth2demo.server.model.repository.AuthorizationConsentRepository;
...
public class JdbcOAuth2AuthorizationConsentService implements OAuth2AuthorizationConsentService {
  ...
  public JdbcOAuth2AuthorizationConsentService(AuthorizationConsentRepository authorizationConsentRepository, RegisteredClientRepository registeredClientRepository) {
